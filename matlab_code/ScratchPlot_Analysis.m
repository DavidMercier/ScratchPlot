...
if config.plotNumb == 1
    ...
    numTestMin = config.plotNumb-1;
    numTestMax = numTestMin;
end

for ii = numTestMin:numTestMax
...
if config.plotNumb == 1
    ...
    deltaMAXTAB(1) = ind_scratch(2,numTestMax) - 1;
    deltaMAXTAB(2) = ind_scratch(3,numTestMax) - ind_scratch(2,numTestMax);
    deltaMAXTAB(3) = ind_scratch(4,numTestMax) - ind_scratch(3,numTestMax);
end
...
if config.plotNumb == 1
    ...
    deltaMAXTABCross(1) = ind_cross(2,numTestMax) - ind_cross(1,numTestMax);
end
...
%% All tests
for ii = numTestMin:1:numTestMax
    ...
    dataAnalyzed.allVal(ii).load_2 = data.expValues(ii).load(ind_scratch(2,ii):(ind_scratch(2,ii)+deltaMAXTAB(2)),1);
...
if config.plotNumb == 1
    ...
    dataAnalyzed.loadError_1 = zeros(1,length(dataAnalyzed.dispVertSum_1));
    dataAnalyzed.loadError_2 = zeros(1,length(dataAnalyzed.dispVertSum_2));
    dataAnalyzed.loadError_3 = zeros(1,length(dataAnalyzed.dispVertSum_3));
    dataAnalyzed.dispVertError_1 = zeros(1,length(dataAnalyzed.dispVertSum_1));
    dataAnalyzed.dispVertError_2 = zeros(1,length(dataAnalyzed.dispVertSum_2));
    dataAnalyzed.dispVertError_3 = zeros(1,length(dataAnalyzed.dispVertSum_3));
    dataAnalyzed.dispVertCorrError_1 = zeros(1,length(dataAnalyzed.dispVertSum_1));
    dataAnalyzed.dispVertCorrError_2 = zeros(1,length(dataAnalyzed.dispVertSum_2));
    dataAnalyzed.dispVertCorrError_3 = zeros(1,length(dataAnalyzed.dispVertSum_3));
    dataAnalyzed.dispHoriCrossError = zeros(1,length(dataAnalyzed.dispHoriCrossMean));
    dataAnalyzed.dispVertCrossError = zeros(1,length(dataAnalyzed.dispHoriCrossMean));
end
